...
// ==================== USER SETTINGS ====================
const char* WIFI_SSID = "iPhone";       // <-- put your WiFi name here
const char* WIFI_PASS = "sam12345";   // <-- put your WiFi password here

const char* IFTTT_HOST = "maker.ifttt.com";
const int   IFTTT_PORT = 443; // HTTPS
const char* IFTTT_KEY  = "eMvWc0-T_pewSkPncjogx58cXIrlt3Nd3HgRUkvC-Zo"; // your Webhooks key
